...
try{
  ...
  async function createPost(){
    ...
    const [uidResponse, titleResponse, loremResonse] = await Promise.all([uidPromise, titlePromise, loremPromise]);
    
    const postPromise = makeRequest('POST', api + '/create-post-width-uid',{
      uid: uidResponse.uid,
      title: titleResponse.title,
      content: loremResonse.lorem
    });
    try{
